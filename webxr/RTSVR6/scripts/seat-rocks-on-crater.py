"""
Seat UE rocks on the skirmish crater moon and export a combined GLB for RTSVR6 1v1.

Blender 5.x (headless):
  "C:\\Program Files\\Blender Foundation\\Blender 5.1\\blender.exe" --background --python
    RTSVR6/scripts/seat-rocks-on-crater.py
...
def main() -> int:
    ...
    # Canonical names for ray hits + RTSVR6 Moon_* filter
    for o in mesh_objects(list(bpy.data.objects)):
