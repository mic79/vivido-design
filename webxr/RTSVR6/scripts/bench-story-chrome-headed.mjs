 ...
 *
 *   node RTSVR6/scripts/bench-story-chrome-headed.mjs
 *
...
const OUT = path.join(WEBXR, 'RTSVR6', 'bench-story-chrome-headed');
...
const PROJECTS = [
  ...
  { id: 'RTSVR6', root: path.join(WEBXR, 'RTSVR6'), port: 8795 },
  { id: 'rtsvr6Forest', root: path.join(WEBXR, 'rtsvr6Forest'), port: 8796 },
];
...
async function main() {
  ...
  const pack = {
    ...
    method: {
      harness: 'RTSVR6/scripts/bench-story-chrome-headed.mjs',
