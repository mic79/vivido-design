 ...
 *
 *   node RTSVR6/scripts/export-skirmish-from-ue.mjs
 *   WRITE_LIVE=1 CONFIRM_WRITE_LIVE=1 node RTSVR6/scripts/export-skirmish-from-ue.mjs
 *
 * Barriers (Cross/X canyon): author JSON via gen-skirmish-barriers.mjs, place in
 * UE with add_skirmish_symmetric_barriers.py. Full-map SIMPLE bake of ~2500
 * actors often kills the Python remote — prefer
 *   WRITE_LIVE=1 CONFIRM_WRITE_LIVE=1 node RTSVR6/scripts/merge-skirmish-barriers.mjs
 *   node RTSVR6/scripts/bake-rock-shadows.mjs
 * then smoke with smoke-skirmish-barriers.mjs. export_skirmish_barriers_glb.py
 * is a small barriers-only UE export if you need a fresh mesh bake.
 *
 * Moon *geometry* edits in UE are not used (textured bak moons). All prop /
 * new-object transforms and meshes come from UE (or live-mesh clones for barriers).
 */
