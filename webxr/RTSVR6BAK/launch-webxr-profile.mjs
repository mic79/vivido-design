 ...
 *
 *   node RTSVR6/launch-webxr-profile.mjs
 *   node RTSVR6/launch-webxr-profile.mjs "http://localhost:8080/RTSVR6/"
 */
...
const URL = process.argv[2] || 'http://localhost:8080/RTSVR6/';
