...
/** Standard skirmish plate (m). Story uses 2× linear ⇒ **4× area**. */
...
/** Terrain style: crater rim (standard) vs procedural blocking hills (story). */
export let MAP_TERRAIN_STYLE = /** @type {'crater'|'hills'} */ ('crater');
...
/**
 * Switch between standard skirmish map and Story (4× area, hills terrain).
