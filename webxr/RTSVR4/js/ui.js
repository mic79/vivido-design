...
function createMenu() {
  ...
  `;
  menuEl.innerHTML = `
    <h2 style="color: #0f0; margin: 0 0 20px 0; font-size: 28px; letter-spacing: 0.1em;">RTS VR IV</h2>
    <button id="btn-start-story" style="${btnStyle('#0a6')}" onclick="window._startGame('story')">📖 Story (solo)</button>
