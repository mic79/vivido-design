...
export function sampleMoonTerrainWorldY(wx, wz) {
  ...
  // Horizon skirts use `sampleMoonTerrainWorldYVisual`; the old branch projected noise onto
  // `MAP_PLAYABLE_RADIUS` for d > R, which did **not** match skirt vertices — units floated past
  // the 200×200 m central plate where gameplay still runs (`MAP_UNIT_NAV_RADIUS`).
