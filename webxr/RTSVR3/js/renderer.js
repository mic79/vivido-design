...
function createResourceFieldMeshes() {
  ...
  resourceFieldMesh = new THREE.InstancedMesh(geometry, material, RESOURCE_FIELD_LAYOUT.length);
...
// --- World fog-of-war tint (semi-transparent; cleared where your team has current vision) ---
function createFogPlane() {
  ...
  const geo = new THREE.PlaneGeometry(MAP_NAV_PLANE_SPAN_M, MAP_NAV_PLANE_SPAN_M, 1, 1);
