...
(function () {
  ...
  AFRAME.registerComponent('leg-ik-world', {
    ...
    _updateVRCrouch: function () {
      ...
      // 12cm deadzone — look-down / slight lean must not register as crouch (Echo especially
      // would squat the neck into HMD view and suppress walk blend weights).
      const CROUCH_START = 0.12;
